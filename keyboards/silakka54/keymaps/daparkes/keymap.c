...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS, KC_LCBR,   KC_RCBR,   KC_LBRC, KC_RBRC,  KC_F12,
        KC_TRNS,  KC_VOLD, KC_VOLU, KC_MPRV, KC_MNXT, KC_MPLY,                            KC_LEFT, KC_DOWN,   KC_UP,     KC_RGHT, KC_EQL,  KC_PLUS,
        KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS, S(KC_NUHS),KC_NUHS,   KC_MINS, KC_UNDS, KC_TRNS,
